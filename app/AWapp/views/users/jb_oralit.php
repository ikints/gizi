<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Jumlah Bayi Mendapatkan ORALIT
      </h1>
    </section>
            ...
            <div class="box-body">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#tab_1" data-toggle="tab">Data Bayi Mendapatkan ORALIT</a></li>
                  <li><a href="#tab_2" data-toggle="tab">Jumlah Bayi Mendapatkan ORALIT</a></li>
                </ul>
                  ...
                  <div class="tab-pane" id="tab_2">
                    <div class="table-responsive">
                      <table id="info" class="table table-bordered table-hover table-responsive">
                        ...
                        <tbody>
                          <?php $i=0; foreach ($jb_oralit as $rows) : $i++; ?>
                            <tr>
                              <td><?php echo $i; ?></td>
