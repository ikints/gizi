            ...
            <div class="box-body">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#tab_1" data-toggle="tab">Data Vitamin</a></li>
                  <li><a href="#tab_2" data-toggle="tab">Jumlah Pemberian Vitamin</a></li>
                </ul>
                  ...
                  <div class="tab-pane" id="tab_2">
                    <div class="table-responsive">
                      <table id="info" class="table table-bordered table-hover table-responsive">
                        ...
                        <tbody>
                          <?php $i=0; foreach ($jb_vitamin as $rows) : $i++; ?>
                            <tr>
                              <td><?php echo $i; ?></td>
